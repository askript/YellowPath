...
let select = document.getElementsByName('stepSelection') // name of select value 
...
let selection = formulaire.elements.list.value;
...
let number = test(selection);
let number2 = select.length-1;
